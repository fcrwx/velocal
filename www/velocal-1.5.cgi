...
my $registration_email = 'velocal@nicola.textdrive.com';
my $registration_name = 'VeloCal Support';
my $reply_email = 'support@velocal.org';
my $reply_name = 'VeloCal Support';
...
my $sendmail = "/usr/sbin/sendmail -i -t -f $registration_email";
...
#		print MAIL "From: $registration_name <$registration_email>\n";
		print MAIL "Reply-to: $reply_name <$reply_email>\n";
