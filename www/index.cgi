...
my $sendmail = '/usr/sbin/sendmail -f support@velocal.org';
...
if ($action eq 'welcome') {
	...
	my $announcements = read_file('announcements.html');
...
END
		...
		if (($check eq 'true') && ($data_valid == 1)) {
			...
			foreach my $member_email (keys %emails) {
				...
				print MAIL "<br>\n";
				print MAIL "<hr>\n";
				print MAIL "Announcements:<br>\n";

				my $announcements = read_file('announcements.html');

				print MAIL "<ul>\n";
				print MAIL $announcements;
